...
**For Jetsons:** Flash jetson to Jetpack 5x
...
```bash
git clone --depth 1 https://github.com/opendatacam/darknet
...
Learn more in the [config documentation](/docs/configuration) page.
